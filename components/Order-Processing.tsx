        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-16 xl:gap-20">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-col">
              ...
              <button className="inline-flex w-fit items-center justify-center rounded-lg bg-gold px-8 py-3.5 text-lg font-semibold text-white shadow-md transition-all hover:bg-[#ff7a28] hover:shadow-lg">
                Get Instant Quote
              </button>
            </div>
          </div>
          ...
          <div className="flex flex-col">
            ...
            <div className="mb-12 grid grid-cols-3 gap-6 lg:mb-14">
              <div className="flex flex-col items-center text-center">
                <div className="mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-gold shadow-md lg:h-16 lg:w-16">
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-8">
              ...
              <div className="flex gap-4">
                <div className="flex h-16 w-16 flex-shrink-0 items-center justify-center rounded-xl bg-goldLight">
                  <svg className="h-9 w-9 text-gold" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
