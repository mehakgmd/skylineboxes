    ...
    <section className="w-full bg-white px-4 py-12 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        ...
        <p className="mb-6 text-base leading-relaxed text-gray-800 sm:text-lg">
          Custom packaging boxes are a powerful marketing tool across multiple industries, offering tailored solutions that enhance brand identity and customer experience.
        </p>

        {/* Subheading */}
        <p className="mb-4 text-base leading-relaxed text-gray-800 sm:text-lg">
          Some of the industries that leverage the benefits of custom printed boxes are:
        </p>
        ...
        <p className="text-base leading-relaxed text-gray-800 sm:text-lg">
          Custom printed boxes can be personalized to align with each product and industry goals.
        </p>
      </div>
    </section>
  );
